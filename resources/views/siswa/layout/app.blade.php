        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{route('siswa.dashboard')}}" class="nav-item nav-link {{request()->routeIs('siswa.dashboard') ? 'active' : ''}}" ><i class="bi bi-house"></i>Dashboard</a>
                    <a href="{{route('siswa.kegiatan')}}" class="nav-item nav-link {{request()->routeIs('siswa.kegiatan*') ? 'active' : ''}}"><i class="bi bi-journal-bookmark"></i>Kegiatan</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="#">Raphy</a>
                        </br>
                        Distributed By <a class="border-bottom" href="#" target="_blank">Raphy</a>
                        </div>
                    </div>
                </div>
            </div>
